...
export default function LoginPage() {
  ...
  const handleDiscordLogin = () => {
    signIn("discord", { callbackUrl: "/sell" })
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-[420px] bg-card border border-border/50 rounded-2xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2 lowercase">sign in to your account</p>
        </div>

        <button
          onClick={handleDiscordLogin}
          className="w-full flex items-center justify-center gap-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold py-3 px-4 rounded-xl transition-colors mb-6"
        >
